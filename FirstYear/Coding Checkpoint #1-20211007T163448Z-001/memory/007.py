   ...
   def create_alien_grid(self):
      ...
      for row_index in range(self.rows):
         ...
         for col_index in range(self.columns):
            ...
            alien = Alien(x, y, alien_width, alien_height, color, self.surface)
            row.append(alien)
         self.alien_grid.append(row)
      print(len(self.alien_grid[0]))
...
class Alien:
   ...
   def touch_edge(self):
	 ...
	 # - self is the Alien ship
      ...
      return (self.rect.top <= 0 or self.rect.bottom >= self.surface.get_height())
