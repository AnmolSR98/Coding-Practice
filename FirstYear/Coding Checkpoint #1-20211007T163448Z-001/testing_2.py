...
def main():
   ...
   pygame.display.set_caption("Fox Bunny Game")
...
class Game:
   ...
   def __init__(self, surface):
      ...
      self.bunny = Animal(self.bunny_color, [150, 100], 20, [2,2], self.surface)
      self.fox = Animal(self.fox_color, [350, 300], 40, [1,1], self.surface)
      self.score = 0
      self.bunny.reset()
      self.fox.randomize()
   ...
   def handle_events(self):
      ...
      for event in events:
         if event.type == pygame.QUIT:
            ...
            self.handle_mouse_up(pygame.MOUSEBUTTONUP)
   ...
   def decide_continue(self):
      ...
      if self.fox.intersects(self.bunny):
   ...
   def draw_game_over(self):
      ...
      fg_color = self.bunny_color
      bg_color = self.fox_color
      game_over_image = game_over_font.render(game_over_string, True,
                                              fg_color, bg_color)
      height = game_over_image.get_height()*0.5
...
class Animal:
   ...
   def move(self):
      ...
      for coord in range(len(size)):
         self.center[coord] += self.velocity[coord]
